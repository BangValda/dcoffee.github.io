...
<body>
    ...
    <div class="custom-bg">
        <div class="container pt-5">
            ...
            <div class="row row-cols-5 g-2 mt-5 text-center fw-semibold">
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/kopi1.png" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">ARABICA COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI2.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">ROBOUSTA COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI3.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">EKSCELSA COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPi4.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">LUWAK COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI5.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">TUBRUK COFFEE</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row row-cols-5 mt-5 text-center fw-semibold">
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI6.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">MACHIATTO COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI7.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">CUBAN EKSPRSSO COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        ...
                        <div class="card-body">
                            <p class="card-text mt-3">COLD BREW COFFEE</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI 9.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm rounded-3 custom-card">
                        <img src="img/KOPI10.jpg" class="custom-img" alt="Coffee 1">
                        <div class="card-body">
                            <p class="card-text mt-3">Kopi Kenangan</p>
                        </div>
                    </div>
    ...
    <div class="recom-cont">
        <div class="recom">
            <h2 class="pt-5 fw-bold">RECOMMENDATION</h2>
            <div class="recom-fill mt-5 mySwiper">
                <div class="fill swiper-wrapper">
                    <div class="img-fill swiper-slide"><img src="img/KOPI2.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI3.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI4.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI5.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI6.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI7.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI 8.jpg" alt=""></div>
                    <div class="img-fill swiper-slide"><img src="img/KOPI 9.jpg" alt=""></div>
                </div>
            </div>
    ...
    <div class="snacks">
        <div class="snacks-fill">
            <div class="sna-fill">
                <h1 class="fw-bold">D'COFFE</h1>
                <h2 class="fw-bold">NEED SNACKS ?</h2>
                <p>HUNGRY ?</p>
            ...
            <div class="sna-col">
                <img src="img/mkn1.jpg" alt="">
                <img src="img/mkn2.jpg" alt="">
                <img src="img/mkn3.jpg" alt="">
                <img src="img/mkn4.jpg" alt="">
